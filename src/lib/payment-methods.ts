  ...
  return [
    {
      ...
      account_value: null,
      instructions:
        'Pay with your bank card via FIB transfer, then confirm your order on Discord.',
      sort_order: 1,
      is_active: true,
      available: true,
    },
    {
      ...
      instructions:
        'Send the exact IQD equivalent in BTC or USDT to our wallet, then confirm on Discord with the transaction hash.',
      sort_order: 2,
      is_active: true,
      available: true,
    },
    {
      ...
      account_value: null,
      instructions:
        'Contact us on Discord for FIB or FastPay payment details, then confirm your order there.',
      sort_order: 3,
      is_active: true,
      available: true,
    },
    {
      ...
      icon: 'MessageCircle',
      account_value: null,
      instructions: 'Message us on Discord to complete your payment details.',
      sort_order: 4,
      is_active: true,
      available: true,
    },
